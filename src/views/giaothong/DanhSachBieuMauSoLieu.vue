<template>
  <div id="main" class="main">
    <div class="pagetitle">
      <h1>Danh sách biểu mẫu số liệu giao thông</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/home">Trang chủ</a></li>
          <li class="breadcrumb-item">Giao thông</li>
          <li class="breadcrumb-item active">Danh sách biểu mẫu số liệu</li>
        </ol>
      </nav>
    </div>
  ...
  export default {
    ...
    methods: {
          ...
          (res) => {
            ...
            if (res?.success) {
              ...
              this.baocaobieumausolieus.forEach(baocao_item => {
                console.log(baocao_item.ngayBatDau, baocao_item.ngayKetThuc);
      ...
      openform(method, baocao_bmslObj) {
        this.$router.push({
          name: 'giaothong.editbieumausolieu', params: {
            method: method,
