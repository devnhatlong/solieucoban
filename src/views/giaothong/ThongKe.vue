  ...
  <div id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="row mb-3" id="divThongkeVuViec">
        <table id="tableThongKeTNGT" class="table table-sm table-bordered small table-striped text-center">
          <thead>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      exportExcel() {
        // Lấy phần tử bảng
        const table = document.getElementById('tableThongKeTNGT');
        ...
        XLSX.writeFile(workbook, 'thongkesolieutngt.xlsx');
      },
      apdung_onclick() {
